...
Tu pedido ${itemName} x${order.quantity} ya esta listo.
...
Avisanos por este chat cuando envies el pago.
...
Recorda tener el importe justo al recibir tu pedido.
            ...
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  ¿Deseas enviar un WhatsApp al cliente avisando que su pedido
                  ya esta listo?
                </div>
          ...
          <div className="modal fade show d-block" tabIndex="-1">
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  ¿Seguro que queres eliminar este pedido? Se devolvera el stock
                  del plato.
          ...
          <div className="row g-2">
            <div className="col-6 col-md-4 col-lg-2">
              <div className="border rounded p-2 bg-light">
                <div className="text-muted small">Total del dia</div>
            ...
            <div className="col-6 col-md-4 col-lg-2">
              <div className="border rounded p-2 bg-light">
                ...
                <div className="fw-bold text-danger">${formatMoney(stats.unpaid)}</div>
              </div>
            </div>
            <div className="col-6 col-md-4 col-lg-2">
              <div className="border rounded p-2 bg-light">
                <div className="text-muted small">Pendientes de preparacion</div>
                  ...
                  <div className="card-body py-2">
                    <div className="d-flex justify-content-between flex-wrap gap-1">
                      ...
                      <div className="text-end">
                        <div className="fw-bold">${formatMoney(o.total_amount)}</div>
                        {time && <div className="small text-muted">Hora: {time}</div>}
                      </div>
                    </div>
                    ...
                    <div className="d-flex justify-content-between align-items-center mt-2 flex-wrap gap-2">
                      ...
                      <div className="d-flex flex-wrap gap-3 align-items-center">
                        <div className="form-check">
                          ...
                          />
                          <label className="form-check-label small" htmlFor={`paid-${o.id}`}>
                            Pagado
                          </label>
                        </div>
                        ...
                        <div className="form-check">
                          ...
                          />
                          <label className="form-check-label small" htmlFor={`prep-${o.id}`}>
                            Preparado
                          </label>
                        </div>
